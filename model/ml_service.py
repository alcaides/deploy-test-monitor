...
def classify_process():
    ...
    while True:
        ...
        # q = "{'text': 'sometext', 'id':'qs_id'}" -> hay que parsearlo con 
        # elem.decode. 
        for q in queue:
            ##############################################################
            # COMPLETAR AQUI:
            ...
            db.set(job_id, json.dumps(response)) #json dumps para de nuevo 
            # mandar texto a la cola -redis lo requiere. No enviamos el
            # diccionario, sino el string del diccionario
